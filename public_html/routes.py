...
#
default_application = 'fansubcheck'    # ordinarily set in base routes.py
...
routes_in = ((r'.*:/favicon.ico', r'/examples/static/favicon.ico'),
             ...
             ('/add_qc', '/fansubcheck/default/add_qc'),
             ('/my_qc_list', '/fansubcheck/default/qc_list'),
             ('/public_qc_list', '/fansubcheck/default/public_qc_list'),
             ('/home', '/fansubcheck/default/index'))
...
routes_out = ((r'.*http://otherdomain.com.* /app/ctr(?P<any>.*)', r'\g<any>'),
              (r'/app(?P<any>.*)', r'\g<any>'),
             ('/fansubcheck/default/add_qc', '/add_qc'),
             ('/fansubcheck/default/qc_list', '/my_qc_list'),
             ('/fansubcheck/default/public_qc_list', '/public_qc_list'),
             ('/fansubcheck/default/index', '/home'))
