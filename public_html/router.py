...
routers = dict(
    ...
    # base router
    BASE = dict(default_application = 'fansubcheck'),
    fansubcheck= dict(languages=['en', 'fr', 'it', 'es'], default_language='en'),
    myapp=       dict(languages=['en', 'fr', 'it', 'es'], default_language='en')
)
